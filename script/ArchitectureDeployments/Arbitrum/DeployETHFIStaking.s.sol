...
/**
 *  source .env && forge script script/ArchitectureDeployments/Arbitrum/DeployETHFIStaking.s.sol:DeployETHFIStakingScript --with-gas-price 10000000 --evm-version london --broadcast --etherscan-api-key $ARBISCAN_KEY --verify
 * @dev Optionally can change `--with-gas-price` to something more reasonable
 */
contract DeployETHFIStakingScript is DeployArcticArchitecture, ArbitrumAddresses {
