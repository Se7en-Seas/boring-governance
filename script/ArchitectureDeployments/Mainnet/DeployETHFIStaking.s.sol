...
/**
 *  source .env && forge script script/ArchitectureDeployments/Mainnet/DeployETHFIStaking.s.sol:DeployETHFIStakingScript --with-gas-price 10000000000 --slow --broadcast --etherscan-api-key $ETHERSCAN_KEY --verify
 * @dev Optionally can change `--with-gas-price` to something more reasonable
 */
contract DeployETHFIStakingScript is DeployArcticArchitecture, MainnetAddresses {
